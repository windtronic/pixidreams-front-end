        ...
        <div className="body">
          ...
          <section className="contentContainer">
            ...
            <div className="memberCard">
              <h2 className="homeTitle"><span>TONI</span></h2>
            ...
            <div className="memberCard">
              <h2 className="homeTitle"><span>JASON</span></h2>
